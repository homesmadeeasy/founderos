...
const PROTECTED_PREFIXES = ['/dashboard', '/morning', '/objects', '/memory', '/knowledge', '/executive', '/projects', '/goals', '/ideas', '/review', '/weekly-review', '/patterns', '/settings', '/onboarding', '/memory-search']
